...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        // latest()->when(request()->q, function($users) {
    ...
    public function update(Request $request, User $user)
    {
        ...
        if($user){
            //redirect dengan pesan sukses
            return redirect('/akses/user')->with(['success' => 'Data Berhasil Diupdate!']);
        }else{
            //redirect dengan pesan error
            return redirect('/akses/user')->with(['error' => 'Data Gagal Diupdate!']);
        }
    }
