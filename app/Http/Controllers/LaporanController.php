...
class LaporanController extends Controller
{
  public function __construct()
  {
    ...
    $this->middleware(['permission:laporan.index|laporan.create|laporan.edit|laporan.detail']);
  ...
  public function pdfHasilUjianPersiswa(Request $request)
  {
    ...
    $jumlah_jawaban_benar = Jawab::where('id_soal', $request->soal)
      ...
      ->first();
    $pdf = PDF::
    loadView('laporan.pdf.hasil_ujian', compact('jawabs', 'siswa', 'soals', 'jawabBenar', 'jumlah_jawaban_benar', 'jawab_first', 'jumlah_soal'));
