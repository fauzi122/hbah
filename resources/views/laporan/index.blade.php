...
<div class="col-md-8">
	<div class="box box-primary">
		<div class="box-header with-border">
			<h3 class="box-title">Laporan Ujian per-Kelas</h3>
		</div>
		<div class="box-body">
			<table class="table table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><a href="{{ url('/elearning/laporan/detail-kelas/'.$data_kelas->id) }}" class="btn btn-success btn-xs">Lihat Data</a></td>
					</tr>
					@endforeach
					@else
					<tr>
