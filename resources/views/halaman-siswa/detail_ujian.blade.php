@extends('layouts.app')
@section('title', 'Soal Ujian - '.Auth::user()->nama)
@section('breadcrumb')
...
<div class="col-md-12">
	<div class="box box-primary">
		<div class="box-header with-border">
			<h3 class="box-title">Detail Soal Ujian</h3>
			...
			<div class="row">
				<div class="col-sm-12">
					...
					{{--  <div style="border: dotted #0723e8; padding: 10px; margin-bottom: 15px;">  --}}
						...
						$mulai=$soal->tgl_ujian;
						$selsai=$soal->tgl_selsai_ujian;
						@endphp

						@if ( $selsai >= $tanggal )
						<button class="btn btn-primary btn-lg btn-block" disabled>Waktu Sudah Lewat</button>
						
						@elseif( $mulai >= $tanggal )
						...
						@else
						<button class="btn btn-primary btn-lg btn-block" disabled >Belum Waktunya Mengerjakan</button>
...
<div id="specialstuff" class="row" style="display: none; overflow-y: scroll !important;">
	<div style="height: 40px; background: #0707e6d3; color: rgb(242, 249, 250); margin-bottom: 10px">
		<p style="padding-top: 8px; padding-left: 15px; font-weight: bold;">Ujian Online SMA Negeri 1 Ciseeng</p>
	</div>
	<div class="col-sm-9">
