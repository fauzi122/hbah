	...
	<div class="col-md-12">
	  <div class="box box-primary">
	    <div class="box-header with-border">
	      <h3 class="box-title"> <i class="fa fa-check-square"></i> SOAL UJIAN TENGAH SEMESTER - {{ Auth::user()->nama }}</h3>
				...
				<table id="example1" class="table table-bordered table-striped">
						...
						@if($pakets->count())
							...
							<tr>
								...
								<td>
									@if($check)
									<a href="{{ url('siswa/ujian/finish/'.$paket_soal->id_soal) }}" class="btn btn-xs btn-danger">LIHAT</a>
									@else
									<a href="/siswa/ujian/detail/{{ $id}}" class="btn btn-xs btn-primary">LIHAT</a>
									@endif
								</td>
							</tr>
							@endforeach
