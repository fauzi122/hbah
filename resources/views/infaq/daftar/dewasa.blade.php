                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                              <div class="tab-pane active" id="tabInfo">
                                ...
                                @endphp  --}}
                                <form method="POST" action="/infaq/daftar" class="form-horizontal">
                                    {{ csrf_field() }}
                                  <div class="box-body" style="padding-bottom: 0;">
                                    <div class="form-group">
                                      <label for="nama" class="col-md-3 control-label">Nama Lengkap</label>
                                      <div class="col-sm-5">
                                        <input type="hidden" name="id_daftar" value="{{ $posts->id }}">
                                        <input type="hidden" name="id_priode" value="{{ $posts->id_priode }}">
                                        <input type="hidden" name="id_level" value="{{ $posts->id_level }}">
                                        <input type="text" readonly class="form-control" name="nm_santri"  value="{{ $posts->nm_lengkap }}">
                                      </div>
                                    </div>
                                      ...
                                      <div class="col-sm-5">
                                        <select class="form-control selectpicker" name="jns_bayar">
                                          <optgroup label="Pilih Jenis Infaq">
                                              <option>Infaq Pendaftaran</option>
