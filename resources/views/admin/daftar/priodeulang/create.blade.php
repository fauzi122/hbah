    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
           ...
           Form Input Priode Daftar Ulang</h3>
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                              <div class="tab-pane active" id="tabInfo">
                                ...
                                <form method="POST" action="/front/priode-ulang" class="form-horizontal">
                                    {{ csrf_field() }}
                                  <div class="box-body" style="padding-bottom: 0;">
                                    <div class="form-group">
                                      <label for="nama" class="col-md-3 control-label">Priode/Gelombang Daftar Ulang</label>
                                      <div class="col-sm-5">
                                      
                                        <input type="text" placeholder="Maukan Gelombang Daftar Ulang"
                                    ...
                                    <div class="form-group">
                                      <label for="ket" class="col-md-3 control-label">Status Daftar Ulang</label>
                                      <div class="col-sm-5">
