                            ...
                            <div class="input-group mb-3">
                                @can('posts.create')
                                    <div class="input-group-prepend">
                                        <a href="/front/priode-ulang/create" class="btn btn-primary" style="padding-top: 10px;">
                                ...
                                <tr>
                                   ...
                                   @endif
                                    ...
                                    <td class="text-center">
                                        ...
                                        @can('posts.edit')
                                        <a href="{{ url('/front/daftar-ulang/'.$id) }}" class="btn btn-sm btn-primary">
                                            <i class="fa fa-check"title="List Siswa" ></i>
                                        </a>

                                        @endcan

                                        @can('posts.edit')
                                            <a href="/front/daftar-anak/{{ $post->id}}/edit" class="btn btn-sm btn-success">
