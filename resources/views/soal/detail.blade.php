...
<div class="col-md-4">
  ...
  @if($soal->jenis == 1 or $soal->jenis == 2 or $soal->jenis == 3)
          ...
          <tr>
            ...
            <td align="center">
              <div id="wrap-status-soal{{ $data_kelas->id }}">
                ...
                <span data-toggle="tooltip" title="Kelas ini dapat mengerjakan soal Anda. 
                Klik untuk merubah status soal pada kelas ini." id="terbit-soal{{ $data_kelas->id }}">
                <i style="color: limegreen; font-size: 16pt; cursor: pointer;" class="fa fa-check-square"></i></span>
                @else
                <span data-toggle="tooltip" title="Kelas ini tidak dapat mengerjakan soal Anda.
                 Klik untuk merubah status soal pada kelas ini." id="terbit-soal{{ $data_kelas->id }}">
                 <i style="color: red; font-size: 16pt; cursor: pointer;" class="fa fa-minus-square"></i></span>
                @endif
                @else
                <span data-toggle="tooltip" title="Kelas ini tidak dapat mengerjakan soal Anda.
                Klik untuk merubah status soal pada kelas ini." id="terbit-soal{{ $data_kelas->id }}">
              ...
              $("#terbit-soal{{ $data_kelas->id }}").click(function() {
                ...
                $.ajax({
                  ...
                  success: function(data) {
                    if (data == 'Y') {
                      $("#terbit-soal{{ $data_kelas->id }}").html('<i style="color: limegreen; font-size: 16pt; cursor: pointer;" class="fa fa-check-square"></i>');
                    } else {
                      $("#terbit-soal{{ $data_kelas->id }}").html('<i style="color: red; font-size: 16pt; cursor: pointer;" class="fa fa-minus-square"></i>');
                    }
                  }
                });
              });
...
<div class="col-md-8">
  <div class="box box-primary">
    ...
    <div class="box-body">
      <button type="button" id="btn-soal" class="btn btn-primary btn-md">
        <i class="fa fa-pencil"></i> Tulis Soal</button>
  ...
  <div class="box box-warning">
    ...
    <div class="box-body">
      <button type="button" id="btn-soal-essay" class="btn btn-primary btn-md">
        <i class="fa fa-pencil"></i> Tulis Soal</button>
      ...
      <table class="table table-hover table-striped" id="table_detail_soal_essay">
        <thead>
          <tr>
            <th>Soal</th>
            <th>Status</th>
