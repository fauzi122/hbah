    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
           ...
           Form Tambah Paket Soal <b> Ujian Akhir Semester </b></h3>
...
<form class="form-horizontal"action="/elearning/soal/uas" method="POST">
  @csrf
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        ...
        name="paket" value="UAS" readonly >{!! old('judul') !!}
        @error('paket')
