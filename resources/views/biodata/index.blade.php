...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-user-friends"></i> Biodata Santri</h3> 
        <div class="pull-right">
            {{-- <form action="" method="POST">
                @csrf
                <button class="btn btn-danger" type="submit">
                    <i class="fa fa-trash"></i> Kosongkan Jadwal
                </button>  
            </form> --}}
        </div>
        ...
        <!-- Button untuk memunculkan modal import Excel -->
        ...
        <!-- Link untuk download format Excel -->
        <a href="{{ asset('file/jadwalok.xlsx') }}" class="btn btn-info my-3">
            <i class="fa fa-file"></i> Format Upload
        </a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/biodata/show/{{ $b->id }}" class="btn btn-xs btn-info"><i class="fa fa-tag"></i> detail</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
