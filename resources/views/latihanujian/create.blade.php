...
@section('breadcrumb')
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ url('/elearning/soal/uas') }}">Soal</a></li>
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
           ...
           Form Tambah Paket Soal <b> Latihan Ujian  </b></h3>
...
<form class="form-horizontal"action="/elearning/latihan" method="POST">
  @csrf
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        <input type="number" name="jenis" value="2" hidden readonly>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        ...
        name="paket" value="LATIHAN" readonly >{!! old('judul') !!}
        @error('paket')
